...
struct ViewIdTag;
struct ModelIdTag;
struct ProviderCharacterIdTag;
struct VoiceIdTag;
struct SurfaceIdTag;
struct WorkspaceIdTag;
struct PersonaIdTag;
struct PermissionProfileIdTag;
struct ToolProfileIdTag;
...
using ProviderCharacterId = Id<ProviderCharacterIdTag>;
using VoiceId = Id<VoiceIdTag>;
...
using ToolProfileId = Id<ToolProfileIdTag>;
