...
enum class SlashCommandAction {
  ...
  select_tool_profile,
  disable_tools,
  reset_tool_narrowing,
  enable_tool_category,
  disable_tool_category,
  enable_tool,
  disable_tool,
  set_model_tool_profile_maximum,
  inherit_model_tool_profile_maximum,
  set_persona_tool_profile_maximum,
  inherit_persona_tool_profile_maximum,
